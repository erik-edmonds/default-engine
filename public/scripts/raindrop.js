            ...
            205: [
              function (t, e, i) {
                ...
                (0, a.default)([
                  ...
                  {
                    name: "textureRainBg",
                    src: "data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",
                  },
                ]).then(function (t) {
                  var e;
                  (c = t.textureRainFg.img),
                    ...
                    (window.__rainRenderer = g),
                    (window.__rainFgCanvas = d),
                    (window.__rainFgCtx = p),
                    ...
                    init: function () {
                      (this.width = this.canvas.width),
                        ...
                        (this.gl = new n.default(
                          ...
                          {
                            alpha: !0,
                            // PATCHED -- see RainScene.jsx. blend() ends in
                            // rgb=(fgm+bgm*ia)/a, i.e. it divides the colour
                            // back out by alpha and returns STRAIGHT alpha.
                            // premultipliedAlpha defaults to true, so the
                            // compositor was treating that straight colour as
                            // if it were already multiplied and drawing the
                            // droplets' soft antialiased edges at full
                            // strength instead of scaled by their alpha. That
                            // is the white ring around every drop: brightest
                            // exactly where alpha is lowest.
