export { vertexShader } from './roundedBoxWater'
...
vec3 getWallColor(vec3 point) {
  ...
  // See roundedBox.ts's identical note: normalizing by a reference distance
  // instead of raw 1/distance keeps this pool's much larger scale from
  // reading as uniformly near-black past the first couple of units.
